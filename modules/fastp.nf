process FASTP {
    ...
    fastp -i ${name}_1.fastq -I ${name}_2.fastq -o ${name}_1.trimmed.fastq -O ${name}_2.trimmed.fastq --detect_adapter_for_pe --json ${name}_fastp.json --html ${name}_fastp.html --thread ${params.threads}
